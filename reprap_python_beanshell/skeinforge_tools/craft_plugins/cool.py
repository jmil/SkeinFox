...
class CoolPreferences:
	...
	def __init__( self ):
		...
		self.maximumCool = preferences.FloatPreference().getFromValue( 'Maximum Cool (Celcius):', 2.0 )
		self.archive.append( self.maximumCool )
	...
	def parseLine( self, line ):
		...
		if firstWord == 'G1':
			...
			if remainingOrbitTime > 0.0 and self.boundaryLayer != None:
				layerCool = self.coolPreferences.maximumCool.value * remainingOrbitTime / self.coolPreferences.minimumLayerTime.value
