...
def getCraftSequence():
	"Get the sequence carve,preface,inset,fill,multiply,speed,raft,tower,jitter,comb,clip,cool,stretch,hop,wipe,oozebane,home,lash,fillet,unpause,export."
	return 'carve,preface,inset,fill,multiply,speed,raft,tower,jitter,comb,clip,cool,stretch,hop,wipe,oozebane,home,lash,fillet,unpause,export'.split( ',' )
